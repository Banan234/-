// Файл задаёт общие правила валидации payload заявки, телефонов, email и лимитов формы.
...
// Отбрасывает повторяющиеся и последовательные номера, которые пропускала
// старая проверка `digits.length >= 10`.
