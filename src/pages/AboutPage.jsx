  ...
  return (
    <section className="section">
      <Container>
        ...
        <div className="about-facts" style={{ marginTop: 40, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 24 }}>
          {[
            ...
            <div key={label} style={{ background: 'var(--bg-soft)', borderRadius: 16, padding: '28px 24px', textAlign: 'center' }}>
              <div style={{ fontSize: 36, fontWeight: 800, color: 'var(--primary)' }}>{num}</div>
